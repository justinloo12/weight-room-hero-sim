...
HITTER_FEATURES = [
    ...
    # 2026/recent form blend
    "h_form_exit_velo",
    "h_form_barrel_pct",
    "h_form_launch_angle",
    "h_form_sweet_spot_pct",
    "h_form_hard_hit_pct",
    "h_form_pull_air_pct",
    "h_form_hr_rate",
    "h_form_hr_contact_score",
    "h_form_lifted_power_score",
    # Handedness backbone
    "h_hr_rate_vs_hand",
    "h_hr_pa_vs_hand",
    "h_woba_vs_hand",
...
PITCHER_FEATURES = [
    ...
    "p_hr_contact_risk",
    "p_lift_damage_risk",
    "p_hr_vulnerability_score",
    # 2026/recent form blend
    "p_form_exit_velo_allowed",
    "p_form_hard_hit_pct_allowed",
    "p_form_barrel_pct_allowed",
    "p_form_launch_angle_allowed",
    "p_form_sweet_spot_pct_allowed",
    "p_form_pull_air_pct_allowed",
    "p_form_hr_rate_allowed",
    "p_form_hr_contact_risk",
    "p_form_lift_damage_risk",
